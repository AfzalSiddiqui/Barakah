        ...
        <View style={{ backgroundColor: colors.background, borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: '85%' }}>
          <ScrollView contentContainerStyle={{ padding: 20 }}>
            ...
            <View className="items-center mb-4">
              <View style={{ width: 40, height: 4, borderRadius: 2, backgroundColor: hexToRgba(colors.textSecondary, 0.3) }} />
            </View>
                ...
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    backgroundColor: transactionType === type
                      ? (type === 'purchase' ? colors.error : colors.success)
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      paddingVertical: 6,
                      borderRadius: 14,
                      backgroundColor: isActive ? meta.color : hexToRgba(colors.textSecondary, 0.1),
                      flexDirection: 'row',
                      alignItems: 'center',
                      gap: 4,
                    }}
            ...
            <View className="flex-row mt-2" style={{ gap: 12 }}>
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderRadius: 12,
                  alignItems: 'center',
                  backgroundColor: hexToRgba(colors.textSecondary, 0.15),
                }}
              >
